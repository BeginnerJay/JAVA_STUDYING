...
public class ObjectCopy3 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < bookArray1.length; i++) {
            ...
            // bookArray1 배열의 요소를 새로 생성한 bookArray2 배열 인스턴스에 복사
        ...
        bookArray1[0].setBookName("나목"); bookArray1[0].setAuthor("박완서");
        ...
        for (int i = 0; i < bookArray2.length; i++) {
            bookArray2[i].showBookInfo(); // bookArray2 배열요소의 값은 그대로 있다.
        }
    }
}
